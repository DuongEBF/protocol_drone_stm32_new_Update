...
#define HYP_MSGS_BATTERYSTATUS_MAX_SIZE 66
#define HYP_MSGS_BATTERYSTATUS_SIGNATURE (0x26FBAB1359C9F512ULL)

#define HYP_MSGS_BATTERYSTATUS_ID 1000
...
class hyp_msgs_BatteryStatus_cxx_iface;
#endif


struct hyp_msgs_BatteryStatus {

#if defined(__cplusplus) && defined(DRONECAN_CXX_WRAPPERS)
    using cxx_iface = hyp_msgs_BatteryStatus_cxx_iface;
#endif
...
uint32_t hyp_msgs_BatteryStatus_encode(struct hyp_msgs_BatteryStatus* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool hyp_msgs_BatteryStatus_decode(const CanardRxTransfer* transfer, struct hyp_msgs_BatteryStatus* msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _hyp_msgs_BatteryStatus_encode(uint8_t* buffer, uint32_t* bit_ofs, struct hyp_msgs_BatteryStatus* msg, bool tao);
static inline bool _hyp_msgs_BatteryStatus_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct hyp_msgs_BatteryStatus* msg, bool tao);
void _hyp_msgs_BatteryStatus_encode(uint8_t* buffer, uint32_t* bit_ofs, struct hyp_msgs_BatteryStatus* msg, bool tao) {
...
/*
 decode hyp_msgs_BatteryStatus, return true on failure, false on success
*/
bool _hyp_msgs_BatteryStatus_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct hyp_msgs_BatteryStatus* msg, bool tao) {
...
struct hyp_msgs_BatteryStatus sample_hyp_msgs_BatteryStatus_msg(void);
#endif
#ifdef __cplusplus
} // extern "C"
...
BROADCAST_MESSAGE_CXX_IFACE(hyp_msgs_BatteryStatus, HYP_MSGS_BATTERYSTATUS_ID, HYP_MSGS_BATTERYSTATUS_SIGNATURE, HYP_MSGS_BATTERYSTATUS_MAX_SIZE);
